...
{
pdf(paste0("Gene dendrogram and module colors before merge (",current_groupname,"_",current_area,").pdf"), height=10, width=15)
...
write.csv(x=df_mod,file=paste0("modules_",maptype,"_unmerged_functionAnnotation",current_area,"_",current_groupname,".csv"), row.names = FALSE)
head(df_mod)
```
...
diag(plotDiss) = NA; 
{
  pdf(paste0("Gene dendrogram and heatmap before merge (",current_groupname,"_",current_area,").pdf"), height=10, width=15)
...
```{r}
pdf(paste0("Clustering of module eigengene before merge_",current_groupname,".pdf"), height=10, width=15)
...
pdf(paste0("Clustering of module eigengene (",current_area,"_",current_groupname,")_sample.pdf"), height=10, width=15)
...
diag(plotDiss) = NA; 
{
    pdf(paste0("Gene dendrogram and heatmap after merge (",current_area,"_",current_groupname,").pdf"), height=11, width=10)
    TOMplot(plotDiss, 
        selectTree, 
        selectColors, 
        main = "Network heatmap plot, selected genes") 
